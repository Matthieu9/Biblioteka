...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="sous_dossiers/a_propos.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">À propos</a>
    <a href="sous_dossiers/Nouveautés.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Nouveautées</a>
    <a href="sous_dossiers/Documentations.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Documentations</a>
    <a href="sous_dossiers/All_categories.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Catégories</a>
    <a href="sous_dossiers/contact.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Contacte</a>
  </div>

...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="a_propos" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">À propos</a>
    <a href="Nouveautés.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Nouveautées</a>
    <a href="Documentation.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Documentations</a>
